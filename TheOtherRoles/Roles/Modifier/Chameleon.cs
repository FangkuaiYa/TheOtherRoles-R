...
namespace TheOtherRoles.Roles.Modifier
{
    public class Chameleon : RoleBase
    {
        ...
        public static RoleInfo Info = new RoleInfo("Chameleon", color, "You're hard to see when not moving", "You're hard to see when not moving", RoleId.Chameleon, false, true);
