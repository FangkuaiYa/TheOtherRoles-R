...
namespace TheOtherRoles.Roles.Modifier
{
    public class AntiTeleport : RoleBase
    {
        ...
        public static RoleInfo Info = new RoleInfo("Anti tp", color, "You will not get teleported", "You will not get teleported", RoleId.AntiTeleport, false, true);

        public static List<PlayerControl> antiTeleport = new List<PlayerControl>();
        public static Vector3 position;

        public AntiTeleport() : base()
        {
            Instance = this;
            RoleName = Info.name;
