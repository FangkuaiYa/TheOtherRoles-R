...
public class CustomColors
{
    ...
    public static void Load()
    {
        ...
        {
            longname = new TranslationInfo("Color-Text", 1), //18
        ...
        colors.Add(new CustomColor
        {
            longname = new TranslationInfo("Color-Text", 2), // 19
        ...
        colors.Add(new CustomColor
        {
            longname = new TranslationInfo("Color-Text", 3),
        ...
        colors.Add(new CustomColor
        {
            longname = new TranslationInfo("Color-Text", 4),
        ...
        colors.Add(new CustomColor
        {
            longname = new TranslationInfo("Color-Text", 5),
        ...
        colors.Add(new CustomColor
        {
            longname = new TranslationInfo("Color-Text", 6),
        ...
        colors.Add(new CustomColor
        {
            longname = new TranslationInfo("Color-Text", 7),
        ...
        colors.Add(new CustomColor
        {
            longname = new TranslationInfo("Color-Text", 8),
        ...
        colors.Add(new CustomColor
        {
            longname = new TranslationInfo("Color-Text", 9),
        ...
        colors.Add(new CustomColor
        {
            longname = new TranslationInfo("Color-Text", 10),
        ...
        colors.Add(new CustomColor
        {
            longname = new TranslationInfo("Color-Text", 11),
        ...
        colors.Add(new CustomColor
        {
            longname = new TranslationInfo("Color-Text", 12),
        ...
        colors.Add(new CustomColor
        {
            longname = new TranslationInfo("Color-Text", 13),
        ...
        colors.Add(new CustomColor
        {
            longname = new TranslationInfo("Color-Text", 14),
        ...
        colors.Add(new CustomColor
        {
            longname = new TranslationInfo("Color-Text", 15),
        ...
        colors.Add(new CustomColor
        {
            longname = new TranslationInfo("Color-Text", 16),
        ...
        colors.Add(new CustomColor
        {
            longname = new TranslationInfo("Color-Text", 17),
        ...
        colors.Add(new CustomColor
        {
            longname = new TranslationInfo("Color-Text", 18), //35 Color Credit: LaikosVK
        ...
        colors.Add(new CustomColor
        {
            longname = new TranslationInfo("Color-Text", 19), //36
        ...
        colors.Add(new CustomColor
        {
            longname = new TranslationInfo("Color-Text", 20),
        ...
        colors.Add(new CustomColor
        {
            longname = new TranslationInfo("Color-Text", 21), //38
        ...
        colors.Add(new CustomColor
        {
            longname = new TranslationInfo("Color-Text", 22), //39
        ...
        colors.Add(new CustomColor
        {
            longname = new TranslationInfo("Color-Text", 23), //40
        ...
        colors.Add(new CustomColor
        {
            longname = new TranslationInfo("Color-Text", 24), // 41
        ...
        foreach (var cc in colors)
        {
            ...
            ColorStrings[id++] = cc.longname.GetString();
    ...
    {
        public TranslationInfo longname;
