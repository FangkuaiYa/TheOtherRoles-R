...
internal class CreateGameOptionsPatch
{
    ...
    public static class CreateGameOptionsStartPatch
    {
        private static void Postfix(CreateGameOptions __instance)
        {
            ...
            UpdateModeButtons(__instance);
        }

        private static void UpdateModeButtons(CreateGameOptions __instance)
        {
            if (SubmergedCompatibility.Loaded) return;

            __instance.modeButtons[0].SelectButton(false);
            __instance.modeButtons[1].SelectButton(false);
            if (modeButtonGS != null) modeButtonGS.SelectButton(false);
            if (modeButtonHK != null) modeButtonHK.SelectButton(false);
            if (modeButtonPH != null) modeButtonPH.SelectButton(false);
            ...
            switch (TORMapOptions.gameMode)
            {
                ...
                case CustomGamemodes.Classic:
                    __instance.modeButtons[0].SelectButton(true);
                    break;
            }
        }
